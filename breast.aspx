...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sort = Util.GetSafeRequestValue(Request, "sort", "距3线");
        if (!IsPostBack)
        {
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        dt.Columns.Add("距3线", Type.GetType("System.Double"));
        ...
        DataTable dtOri = DBHelper.GetDataTable(" select * from alert_near_3_line_list where alert_date = '" + lastTransactDate.ToShortDateString() + "' ");
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            double high = double.Parse(drOri["highest_price"].ToString());
            double low = double.Parse(drOri["lowest_price"].ToString());
            ...
            dr["信号"] = "";
            dr["板数"] = int.Parse(drOri["limit_up_num"].ToString());
            dr["现高"] = high;
            dr["F3"] = f3;
            dr["F5"] = f5;
            dr["前低"] = low;
            dr["幅度"] = Math.Round(100 * (high - low) / low, 2).ToString() + "%";
            dr["3线"] = line3Price;
            dr["现价"] = currentPrice;
            ...
            dr["距3线"] = (stock.kLineDay[currentIndex].startPrice - line3Price) / line3Price;
        ...
        <table width="100%" >
            ...
            <tr>
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="距3线" HeaderText="距3线"></asp:BoundColumn>
