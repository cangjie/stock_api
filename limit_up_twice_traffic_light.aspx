...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            int alertIndex = currentIndex - 2;



            if (!stock.IsLimitUp(alertIndex) || !stock.IsLimitUp(alertIndex - 1) || stock.IsLimitUp(alertIndex - 2)
                || alertIndex < 1 || currentIndex > stock.kLineDay.Length)
            {
                continue;
            }
            ...
            if (stock.kLineDay[alertIndex + 1].startPrice > stock.kLineDay[alertIndex + 1].endPrice
