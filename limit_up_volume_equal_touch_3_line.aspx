...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate, int days)
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if (stock.kLineDay[currentIndex].startPrice >= stock.GetAverageSettlePrice(currentIndex, 3, 3)
            ...
            double prevVolume = stock.kLineDay[limitUpIndex].volume;
            ...
            bool belowed3Line = false;

            for (int i = limitUpIndex + 1; i < currentIndex; i++)
            {
                double line3PriceTmp = stock.GetAverageSettlePrice(i, 3, 3);
                if (stock.kLineDay[i].startPrice <= line3PriceTmp || stock.kLineDay[i].endPrice <= line3PriceTmp)
                {
                    belowed3Line = true;
                    break;
                }
