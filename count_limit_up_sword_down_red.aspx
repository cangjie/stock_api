...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        int days = int.Parse(Util.GetSafeRequestValue(Request, "days", "3"));
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if (alertIndex < 1 || alertIndex + 5 > s.kLineDay.Length)
            {
                continue;
            }
            ...
            if (s.kLineDay[alertIndex + 1].startPrice <= s.kLineDay[alertIndex].endPrice
                || s.kLineDay[alertIndex + 1].endPrice <= s.kLineDay[alertIndex].endPrice || s.IsLimitUp(alertIndex + 1)
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>涨停后MACD金叉15日以上阴线剑鞘后阳线收盘买入</title>
</head>
<body>
