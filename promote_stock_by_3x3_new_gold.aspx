    ...
    public DataTable GetData1()
    {
        ...
        */
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            dr["推荐度"] = Math.Round((maxPrice - stock.LastTrade) / (stock.LastTrade - minPrice), 2);
            ...
            if (
                ...
                dr["名称"] = dr["名称"] + "<a alt=\"" + drOri["gid"].ToString().Trim().Remove(0, 2) + "\"  title=\"两日连涨，跳空和涨幅在特定范围内，当日收阳，并且最高价和收盘价差在1%以内\" >🌟</a>";
