...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter(" select distinct gid , alert_price  from alert_macd where alert_type = '1hr' and alert_time  > '" + currentDate.ToShortDateString() + "'and  alert_time <= '" + currentDate.ToShortDateString() + " 15:00' ", Util.conStr);
        da.Fill(dtOri);
