        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                if (currentDate < DateTime.Parse(DateTime.Now.ToShortDateString()) && currentDateIndex + i + 1 < s.kArr.Length)
                {
                    ...
                    dr[(i + 1).ToString() + "日最高"] =
                        (((hiPrice - byPrice)/byPrice > 0.01) ? "<font color='red' >" + hiPrice.ToString() + "</font>"
                        : "<font color='green' >" + hiPrice.ToString() + "</font>") ;
            ...
            dr["总计"] = (((maxHiprice - byPrice)/byPrice > 0.01) ? "<font color='red' >" + maxHiprice.ToString() + "</font>"
                        : "<font color='green' >" + maxHiprice.ToString() + "</font>") ;
