...
<body>
    <form id="form1" runat="server">
        <table style="width:100%" >
            <tr>
                <td><asp:Calendar ID="calendar" runat="server" BackColor="White" BorderColor="Black" BorderStyle="Solid" CellSpacing="1" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="250px" NextPrevFormat="ShortMonth" Width="100%" >
