...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        dt.Columns.Add("CCI", Type.GetType("System.Double"));
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            stock.LoadKLineDay();
            KLine.ComputeCci(stock.kLineDay);
            ...
            dr["CCI"] = stock.kLineDay[currentIndex].cci - stock.kLineDay[currentIndex - 1].cci;
        ...
        <table width="100%" >
            ...
            <tr>
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="CCI" HeaderText="CCI" SortExpression="CCI|desc"></asp:BoundColumn>
