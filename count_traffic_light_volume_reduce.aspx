...
<script runat="server">
    ...
    public DataTable GetData(string countPage)
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if (!s.IsLimitUp(alertIndex - 2) || s.kLineDay[alertIndex - 1].startPrice <= s.kLineDay[alertIndex - 1].endPrice
                || s.kLineDay[alertIndex].startPrice >= s.kLineDay[alertIndex].endPrice)
            {
                continue;
            }
            ...
            if (buyIndex == 0 || buyIndex + days >= s.kLineDay.Length || s.IsLimitUp(alertIndex) )
            {
                continue;
            }
