...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            int limitUpDayIndex = s.GetItemIndex(DateTime.Parse(drOri["alert_date"].ToString()))-2;
            ...
            if (s.kLineDay[limitUpDayIndex + 2].endPrice > s.kLineDay[limitUpDayIndex + 1].endPrice)
            {
                continue;
            }
