...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter(" select * from alert_jump_high where alert_time  = '" + currentDate.ToShortDateString() + "' and kdj_days in (0, 1, 2) and macd_days <= kdj_days and macd_days > -1 ", Util.conStr);
        da.Fill(dtOri);
