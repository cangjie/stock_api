...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if (stock.kLineDay[currentIndex + 2].startPrice <= stock.kLineDay[currentIndex+1].highestPrice)
            {
                continue;
            }
            ...
            if (Math.Min(stock.kLineDay[currentIndex + 1].startPrice, stock.kLineDay[currentIndex + 1].endPrice) <= stock.kLineDay[currentIndex].highestPrice)
            {
                continue;
            }
            double buyPrice = stock.kLineDay[currentIndex + 2].startPrice;
