...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataTable dtOri = DBHelper.GetDataTable(" select  alert_date, gid from limit_up a where alert_date  >= '2020-1-1' and not exists("
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            try
            {
                ...
                if (dt.Select(" 日期 = '" + s.kLineDay[currentIndex+2].startDateTime.Date.ToShortDateString() + "' and 代码 = '" + s.gid.Trim() + "' ").Length == 0)
                {
                    ...
                    dr["买入"] = Math.Round(s.kLineDay[currentIndex + 2].startPrice, 2).ToString();
