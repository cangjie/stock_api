...
<script runat="server">
    ...
    {
        sort = Util.GetSafeRequestValue(Request, "sort", "3线下 desc");
        try
        {
        ...
        if (!IsPostBack)
        {
            ...
            dg.DataSource = GetHtmlData(GetData().Select("", sort));
            dg.DataBind();
        }
    }
    ...
    public static DataTable GetData(DateTime date)
    {
        ...
        dt.Columns.Add("3线下", Type.GetType("System.Int32"));
        ...
        DateTime alertDate = Util.GetLastTransactDate(date, 1);

        DataTable dtOri = DBHelper.GetDataTable(" select * from alert_predict_3_line where alert_date = '" + alertDate.ToShortDateString() + "'  ");
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            dr["3线下"] = int.Parse(drOri["under_3_line_days"].ToString());
        ...
        <tr>
            <td><asp:DataGrid ID="dg" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Width="100%" AutoGenerateColumns="False" OnSortCommand="dg_SortCommand" AllowSorting="True" >
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="3线下" HeaderText="3线下"></asp:BoundColumn>
