    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        */
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if (currentIndex < 1)
                continue;
            if (stock.IsLimitUp(currentIndex) && stock.kLineDay[currentIndex].startPrice == stock.kLineDay[currentIndex].endPrice
            ...
            if (100 * currentVolume / rate >= stock.kLineDay[currentIndex - 1].volume)
            {
                continue;
            }
