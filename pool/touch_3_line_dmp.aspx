...
<script runat="server">
    ...
    public  DataTable GetData(DateTime currentDate, int days)
    {
        ...
        */
        ...
        //DataTable dtOri = DBHelper.GetDataTable(" select  * from pool where batch_id = '" + timeStamp.Trim() + "'  ");
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            DateTime alertDate = currentDate;
            ...
            try
            {
                DateTime anchorDate = DateTime.Parse(drOri["anchor_date"].ToString());
                anchorIndex = stock.GetItemIndex(anchorDate);
            }
            catch
            {
            ...
            if (macdDays >= 0 )
            {
                ...
                if (stock.kLineDay[currentIndex].lowestPrice < dmp + 0.02 && stock.kLineDay[currentIndex].lowestPrice > dmp - 0.02)
                {
                    isDmp = true;
                }
            }
            ...
            if (stock.kLineDay[currentIndex].lowestPrice < line3 + 0.02 && stock.kLineDay[currentIndex].lowestPrice > line3 - 0.02 )
            {
                isLine3 = true;
            }
