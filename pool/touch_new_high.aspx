    ...
    public  DataTable GetData(DateTime currentDate, int days)
    {
        ...
        */
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            int highIndex = anchorIndex;
            double highestPrice = stock.kLineDay[anchorIndex].highestPrice;
            for (int i = anchorIndex + 1; i <= currentIndex; i++)
            {
            ...
            if (touchNewHighIndex != currentIndex)
            {
                continue;
            }
