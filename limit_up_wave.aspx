...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        dt.Columns.Add("止盈", Type.GetType("System.Double"));
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            double currentLowestPrice = double.MaxValue;

            for (int i = currentIndex; i >= highIndex; i--)
            {
                currentLowestPrice = Math.Min(currentLowestPrice, stock.kLineDay[i].lowestPrice);
            }
            ...
            dr["止盈"] = currentLowestPrice + 0.328 * (highest - currentLowestPrice);
