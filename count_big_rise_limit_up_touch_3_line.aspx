...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        //DataTable dtOri = DBHelper.GetDataTable(" select * from limit_up a where exists  "
        //    + " ( select 'a' from alert_big_rise b where b.low_price > 0 and (b.high_price - b.low_price)/b.low_price > 0.4 and a.gid = b.gid and a.alert_date = b.alert_date ) "
        //    + " and a.alert_date > '2021-1-1' order by alert_date desc  " );
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            {
                line3Price = s.GetAverageSettlePrice(i, 3, 3);
                if (s.kLineDay[i].lowestPrice <= line3Price)
                {
                    buyIndex = i;
                    break;
                }
            ...
            double buyPrice = Math.Round(line3Price, 2);
