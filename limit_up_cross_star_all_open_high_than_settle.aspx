...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        //DateTime limitUpStartDate = Util.GetLastTransactDate(currentDate, 6);
        ...
        DataTable dtOri = DBHelper.GetDataTable(" select gid, alert_date from limit_up where   alert_date  = '"
            + limitUpEndDate.ToShortDateString() + "'  ");
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if (stock.kLineDay[currentIndex].startPrice <= stock.kLineDay[limitUpIndex + 1].endPrice)
            {
                continue;
            }
