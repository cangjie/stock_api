...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        DataTable dtOri = DBHelper.GetDataTable(" select alert_date, gid  from limit_up a  where  "
            ...
            + "' and exists ( select 'a' from limit_up b where b.alert_date = dbo.func_GetLastTransactDate(a.alert_date, 1) and a.gid = b.gid )  "
            + " and not exists ( select 'a' from limit_up c where c.alert_date = dbo.func_GetLastTransactDate(a.alert_date, 2) and a.gid = c.gid )  "
