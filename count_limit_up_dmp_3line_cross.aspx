...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        DataTable dtOri = DBHelper.GetDataTable(" select  * from limit_up where "
            ...
            + " and  alert_date >= '" + startDate.ToShortDateString()
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            double todayDmp = s.dmp(buyIndex);
            double lastDmp = s.dmp(buyIndex - 1);
            if ((lastDmp > s.GetAverageSettlePrice(buyIndex - 1, 3, 3) && todayDmp > s.GetAverageSettlePrice(buyIndex, 3, 3))
                || (lastDmp < s.GetAverageSettlePrice(buyIndex - 1, 3, 3) && todayDmp < s.GetAverageSettlePrice(buyIndex, 3, 3))  )
            {
                continue;
            }
