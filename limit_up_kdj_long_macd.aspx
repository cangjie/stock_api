...
<script runat="server">
    ...
    {
        sort = Util.GetSafeRequestValue(Request, "sort", "开盘");
        if (!IsPostBack)
        {
                    ...
                    switch (drArr[0].Table.Columns[i].Caption.Trim())
                    {
                        ...
                        default:
                            if (System.Text.RegularExpressions.Regex.IsMatch(drArr[0].Table.Columns[i].Caption.Trim(), "\\d日")
                                ...
                                || drArr[0].Table.Columns[i].Caption.Trim().Equals("今涨")|| drArr[0].Table.Columns[i].Caption.Trim().Equals("开盘"))
                            {
    ...
    public static DataTable GetData(DateTime currentDate, int days)
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            int kdjDays = stock.kdjDays(alertIndex);
            if (kdjDays > 1 || kdjDays < 0)
            {
                continue;
            }

            int macdDays = stock.macdDays(alertIndex);
            if (macdDays < 13)
            {
                continue;
            }
...
<head runat="server">
    <title>涨停KDJ刚好金叉MACD金叉13日以上</title>
</head>
<body>
        ...
        <table width="100%" >
            ...
            <tr>
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="开盘" HeaderText="开盘"  ></asp:BoundColumn>
