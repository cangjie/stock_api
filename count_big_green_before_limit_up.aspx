...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            double startPrice = s.kLineDay[alertIndex - 1].startPrice;
            double endPrice = s.kLineDay[alertIndex - 1].endPrice;
            if ((endPrice - startPrice) / startPrice >= -0.05)
            {
                continue;
            }
            if (s.kLineDay[alertIndex].volume < 2 * s.kLineDay[alertIndex - 1].volume)
            {
                continue;
            }
