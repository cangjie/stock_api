...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            {
                if ((s.kLineDay[alertIndex + i ].endPrice - s.kLineDay[alertIndex + i - 1].endPrice) / s.kLineDay[alertIndex + i - 1].endPrice > 0.06)
                {
            ...
            if (s.IsLimitUp(buyIndex))
            {
                continue;
            }
            /*
            if (buyIndex > alertIndex && !s.IsLimitUp(alertIndex))
            {
                continue;
            }
            */
