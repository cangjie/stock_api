...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        DataTable dtOri = DBHelper.GetDataTable(" select alert_date, gid  from limit_up a  where  "
            ...
            + " and exists ( select 'a' from limit_up b where a.gid = b.gid and b.alert_date = dbo.func_getlasttransactdate(a.alert_date, 2)  ) "
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if ((s.kLineDay[alertIndex - 1].endPrice - s.kLineDay[alertIndex - 2].endPrice) / s.kLineDay[alertIndex - 2].endPrice > -0.995)
            {
                continue;
            }
