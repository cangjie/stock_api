...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            double lastSettlePrice = s.kLineDay[alertIndex].endPrice;

            if ((s.kLineDay[alertIndex].highestPrice - lastSettlePrice) / lastSettlePrice 
                - (s.kLineDay[alertIndex].endPrice - lastSettlePrice) / lastSettlePrice < 0.03)
            {
                continue;
            }
