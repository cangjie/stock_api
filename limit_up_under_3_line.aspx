...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if (!stock.IsLimitUp(currentIndex - 1) || stock.kLineDay[currentIndex - 1].endPrice > stock.GetAverageSettlePrice(currentIndex - 1, 3, 3))
            {
                continue;
            }
            ...
            for (int i = currentIndex - 1; !(up3Line && stock.kLineDay[i].endPrice < stock.GetAverageSettlePrice(i, 3, 3)) && i >= 0; i--)
            {
