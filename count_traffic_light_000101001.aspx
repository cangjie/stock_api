...
<script runat="server">
    ...
    public DataTable GetData(string countPage)
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if (alertIndex >= s.kLineDay.Length - 9)
            {
                continue;
            }

            if (s.kLineDay[alertIndex + 1].startPrice <= s.kLineDay[alertIndex + 1].endPrice
                || s.kLineDay[alertIndex + 2].startPrice <= s.kLineDay[alertIndex + 2].endPrice
                ...
                || s.kLineDay[alertIndex + 5].startPrice <= s.kLineDay[alertIndex + 5].endPrice
                || s.kLineDay[alertIndex + 6].startPrice >= s.kLineDay[alertIndex + 6].endPrice
                
                || s.kLineDay[alertIndex + 7].startPrice <= s.kLineDay[alertIndex + 7].endPrice
                || s.kLineDay[alertIndex + 8].startPrice <= s.kLineDay[alertIndex + 8].endPrice
                || s.kLineDay[alertIndex + 9].startPrice >= s.kLineDay[alertIndex + 9].endPrice
