...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        DataTable dtOri = DBHelper.GetDataTable( "  select distinct gid from  alert_foot  where alert_date > '"
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            */
            ...
            int limitUpIndex = stock.GetItemIndex(currentDate.AddDays(-1).Date);
            ...
            */
            ...
            DateTime footTime = DateTime.Parse(lowPriceDrArr[0]["alert_date"].ToString());
            todayLowestPrice = double.Parse(lowPriceDrArr[0]["price"].ToString());
            todayDisplayLowPrice = todayLowestPrice * 1.01;
