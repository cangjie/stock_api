...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        DataTable dtOri = DBHelper.GetDataTable(" select * from limit_up where alert_date = '" + Util.GetLastTransactDate(currentDate, 1) + "' ");
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            bool isTop = true;
            for (int i = 1; i <= 40 && currentIndex - i > 0 ; i++)
            {
                if (stock.kLineDay[currentIndex - i].highestPrice > stock.kLineDay[currentIndex - 1].highestPrice)
                {
                    isTop = false;
                    break;
                }
            ...
            */
            ...
            {
                dr["信号"] = dr["信号"].ToString() + "<a title=\"起步\" >🔥</a>";
            }
