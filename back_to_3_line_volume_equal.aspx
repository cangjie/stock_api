...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sort = Util.GetSafeRequestValue(Request, "sort", "5线涨 desc,日均涨幅 desc");
        if (!IsPostBack)
        {
            try
            {
    ...
    public static DataTable GetData(DateTime currentDate, string days)
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if (stock.kLineDay[currentIndex].lowestPrice >= line3Price * 1.01 || stock.kLineDay[currentIndex].endPrice <= line3Price)
            {
                continue;
            }
...
<head runat="server">
    <title>8天三线上后碰三线调整,以5线持续上涨为优，和大盘关联强。</title>
</head>
<body>
