...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            double open = stock.kLineDay[currentIndex].startPrice;
            double settle = stock.kLineDay[currentIndex - 1].endPrice;
            double high = stock.kLineDay[currentIndex].highestPrice;
