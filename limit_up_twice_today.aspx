...
<script runat="server">
    ...
    + " and not exists ( select 'a' from limit_up c where c.gid = a.gid and c.alert_date > dbo.func_GetLastTransactDate(a.alert_date, 4) and c.alert_date <  dbo.func_GetLastTransactDate(a.alert_date, 1) )  "
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            double volumeToday = stock.kLineDay[currentIndex - 1].volume;  //Stock.GetVolumeAndAmount(stock.gid, DateTime.Parse(currentDate.ToShortDateString() + " " + DateTime.Now.Hour.ToString() + ":" + DateTime.Now.Minute.ToString()))[0];
