    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            */
            ...
            {
                if (type.Trim().Equals("F3") && stock.kLineDay[currentIndex].endPrice <= f3)
                {
                    continue;
                }
                if (type.Trim().Equals("F5") && stock.kLineDay[currentIndex].endPrice <= f5)
                {
                    continue;
                }
