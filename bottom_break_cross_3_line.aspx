...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        DataTable dtOri = DBHelper.GetDataTable(" select * from dbo.bottom_break_cross_3_line where suggest_date = '"
            + calendar.SelectedDate.ToShortDateString() + "' and going_down_3_line_days >= 4 and under_3_line_days >= 4 order by  going_down_3_line_days desc, under_3_line_days desc ");
