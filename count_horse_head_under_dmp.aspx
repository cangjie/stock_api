...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if (alertIndex < 2 || alertIndex >= s.kLineDay.Length - 1 - days)
            {
                continue;
            }
            ...
            if ((s.kLineDay[alertIndex + 1].startPrice - s.kLineDay[alertIndex].endPrice) / s.kLineDay[alertIndex].endPrice <= 0.08)
            {
                continue;
            }
