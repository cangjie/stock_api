...
<script runat="server">
    ...
    public DataTable GetData()
    {
        ...
        DataRow[] drOriArr = dtOri.Select(Util.GetSafeRequestValue(Request, "whereclause", "").Trim(), sort + (!sort.Trim().Equals("")?",":"") + " KDJ, 3线日 , 放量 desc ");
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter(" select * from alert_macd where alert_time = '" + currentDate.ToShortDateString() + " 15:00' ", Util.conStr);
        da.Fill(dtOri);
