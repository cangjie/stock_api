...
<script runat="server">
    ...
    public DataTable GetData()
    {
        try
        {
            ...
            endDate = startDate.AddDays(calendar.SelectedDates.Count - 1);
        }
        catch
        {
        ...
        DataTable dtOri = GetData(startDate, endDate);
    ...
    protected void calendar_SelectionChanged(object sender, EventArgs e)
    {
        ...
        //currentDate = Util.GetDay(startDate, endDate);
        DataTable dt = GetData();
        dg.DataSource = dt;
        dg.DataBind();
    }
    ...
    public static DataTable GetData(DateTime startDate, DateTime endDate)
    {
        ...
        */
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            DateTime currentDate = DateTime.Parse(drOri["alert_date"].ToString().Trim());
...
<body>
    ...
    <div>
        <asp:Button ID="btn" runat="server" Text="下载" OnClick="btn_Click" ></asp:Button>
    </div>
    <div>
        <table width="100%" >
            <tr>
                <td><asp:Calendar runat="server" id="calendar" Width="100%" OnSelectionChanged="calendar_SelectionChanged" BackColor="White" BorderColor="Black" BorderStyle="Solid" CellSpacing="1" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="250px" NextPrevFormat="ShortMonth" SelectionMode="DayWeekMonth" >
