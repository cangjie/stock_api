...
<script runat="server">
    ...
    public static int redSuccess = 0;

    public static int greenCount = 0;

    public static int greenSuccess = 0;
...
<body>
    ...
    <div>
        红：<%=redSuccess.ToString() %> / <%=redCount.ToString() %> = <%=Math.Round(100 * (double)redSuccess/redCount, 2).ToString() %>%<br />
        绿：<%=greenSuccess.ToString() %> / <%=greenCount.ToString() %> = <%=Math.Round(100 * (double)greenSuccess/greenCount, 2).ToString() %>%<br />
