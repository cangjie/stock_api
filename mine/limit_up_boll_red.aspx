...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate, int days)
    {
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            if (stock.GetAverageSettlePrice(currentIndex, 20, 0) < stock.GetAverageSettlePrice(currentIndex - 3, 20, 0)
                || stock.GetAverageSettlePrice(currentIndex - 3, 20, 0) < stock.GetAverageSettlePrice(currentIndex - 5, 20, 0)
                || stock.GetAverageSettlePrice(currentIndex - 5, 20, 0) < stock.GetAverageSettlePrice(currentIndex - 8, 20, 0)
                //|| stock.GetAverageSettlePrice(currentIndex - 3, 20, 0) < stock.GetAverageSettlePrice(currentIndex - 8, 20, 0)
