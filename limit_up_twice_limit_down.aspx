...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        sort = Util.GetSafeRequestValue(Request, "sort", "换手");
        if (!IsPostBack)
        {
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        DataTable dtOri = DBHelper.GetDataTable(" select  * from limit_up_twice a where not  exists ( select 'a' from limit_up b where a.gid = b.gid and a.alert_date = dbo.func_GetLastTransactDate(b.alert_date, 1) )  "
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            */
            ...
            dr["KDJ周"] = kdjWeek;
            dr["MACD周"] = macdWeek;
            dr["换手"] = stock.kLineDay[currentIndex - 1].turnOver.ToString() + "%";

            double maxPrice = stock.kLineDay[currentIndex].highestPrice;
        ...
        <table width="100%" >
            ...
            <tr>
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="MACD周" HeaderText="MACD周" SortExpression="MACD周|asc"></asp:BoundColumn>
                    <asp:BoundColumn DataField="KDJ周" HeaderText="KDJ周" SortExpression="KDJ周|asc"></asp:BoundColumn>
