...
<script runat="server">
    ...
    {
        DataTable dtGid = DBHelper.GetDataTable(" select distinct gid from bread_pool where alert_type <> '' and (highest - lowest)/lowest >= 0.3 ");
    ...
    public DataTable GetData()
    {
        ...
        DataTable dtOri = DBHelper.GetDataTable(" select * from bread_pool where alert_type <> ''  and (highest - lowest)/lowest >= 0.3 "
            + " and alert_date <= '" + Util.GetLastTransactDate(DateTime.Now, 10).ToShortDateString() + "' order by alert_date desc ");
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            {
                double buyPrice = s.kLineDay[firstGreenIndex].endPrice;
                ...
                dr["日期"] = s.kLineDay[firstGreenIndex].endDateTime.ToShortDateString();
