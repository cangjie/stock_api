...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate)
    {
        ...
        dt.Columns.Add("风险差", Type.GetType("System.Double"));
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            double lastRisk = double.Parse(drOri["risk"].ToString());
            ...
            int weekIndex = stock.GetItemIndex(currentDate, "week");
