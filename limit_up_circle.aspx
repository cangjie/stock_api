...
<script runat="server">
    ...
    public static DataTable GetData(DateTime currentDate, int days, int limitNum)
    {
        ...
        */
        ...
        foreach (DataRow drOri in dtOri.Rows)
        {
            ...
            double highest = stock.kLineDay[currentIndex].endPrice;
            ...
            */
            ...
            dr["板数"] = drOri["limit_up_num"].ToString();
            dr["缩量"] = volumeReduce;
            dr["现高"] = highest;
            dr["F3"] = f3;
            dr["F5"] = f5;
